export default function Letras({quantidadeErros, setquantidadeErros, sortearJogo, setsortearJogo, setcorPalavra, setDesabilitar, palavraSorteada, letras, setLetras, desabilitar}) {
